...
export default function WhyIIEI() {
  return (
    <section id="why-iiei" className="py-14 lg:py-20 bg-[#EBF3FC] dark:bg-ink-950 border-b border-ink-900/10 dark:border-white/10 transition-colors">
      <div className="section-padding">
        <Reveal>
          <div className="max-w-3xl mb-10 border-b border-ink-900/10 dark:border-white/10 pb-8">
          ...
          {whyIIEICards.map((card, i) => {
            ...
            return (
              <Reveal key={i} delay={i * 70}>
                <div className="h-full p-8 border border-ink-900/10 dark:border-white/10 bg-white dark:bg-ink-900 hover:border-ink-900 dark:hover:border-white hover:shadow-md transition-all duration-200">
